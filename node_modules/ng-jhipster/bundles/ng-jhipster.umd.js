    ...
    ***************************************************************************** */
    ...
    var JhiItemCountComponent = /** @class */ (function () {
         ...
         */
            function () {
                /** @type {?} */
                var first = (this.page - 1) * this.itemsPerPage === 0
                    ? 1
                    : (this.page - 1) * this.itemsPerPage + 1;
                /** @type {?} */
                var second = this.page * this.itemsPerPage < this.total
    ...
    var JhiMaxbytesValidatorDirective = /** @class */ (function () {
        ...
        JhiMaxbytesValidatorDirective.decorators = [
            { type: i0.Directive, args: [{
                        ...
                        providers: [
                            { provide: forms.NG_VALIDATORS, useExisting: i0.forwardRef(function () { return JhiMaxbytesValidatorDirective; }), multi: true }
                        ]
                    },] }
        ];
        /** @nocollapse */
    ...
    var JhiMinbytesValidatorDirective = /** @class */ (function () {
        ...
        JhiMinbytesValidatorDirective.decorators = [
            { type: i0.Directive, args: [{
                        ...
                        providers: [
                            { provide: forms.NG_VALIDATORS, useExisting: i0.forwardRef(function () { return JhiMinbytesValidatorDirective; }), multi: true }
                        ]
                    },] }
        ];
        /** @nocollapse */
    ...
    var JhiMaxValidatorDirective = /** @class */ (function () {
        ...
        JhiMaxValidatorDirective.decorators = [
            { type: i0.Directive, args: [{
                        ...
                        providers: [
                            { provide: forms.NG_VALIDATORS, useExisting: i0.forwardRef(function () { return JhiMaxValidatorDirective; }), multi: true }
                        ]
                    },] }
        ];
        /** @nocollapse */
    ...
    var JhiMinValidatorDirective = /** @class */ (function () {
        ...
        JhiMinValidatorDirective.decorators = [
            { type: i0.Directive, args: [{
                        ...
                        providers: [
                            { provide: forms.NG_VALIDATORS, useExisting: i0.forwardRef(function () { return JhiMinValidatorDirective; }), multi: true }
                        ]
                    },] }
        ];
        /** @nocollapse */
    ...
    var NgJhipsterModule = /** @class */ (function () {
        ...
        NgJhipsterModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        declarations: __spread(JHI_PIPES, JHI_DIRECTIVES, JHI_COMPONENTS, [
                            JhiTranslateDirective
                        ]),
                        entryComponents: [JhiThreadModalComponent],
                        exports: __spread(JHI_PIPES, JHI_DIRECTIVES, JHI_COMPONENTS, [
                            JhiTranslateDirective,
                            i1.TranslateModule,
                            common.CommonModule
                        ])
    ...
    var JhiEventManager = /** @class */ (function () {
         ...
         */
            function (eventName, callback) {
                /** @type {?} */
                var subscriber = this.observable.pipe(operators.filter(function (event) {
